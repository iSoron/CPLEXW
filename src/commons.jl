...
# Skipping MacroDefinition: CPXDEPRECATEDAPI ( version ) __attribute__ ( ( deprecated ) )
# Skipping MacroDefinition: CPXDEPRECATED ( version ) __attribute__ ( ( deprecated ) )
# Skipping MacroDefinition: CPXEXPORT __attribute__ ( ( visibility ( "default" ) ) )
...
const CPX_VERSION = 12080000
const CPX_VERSION_VERSION = 12
const CPX_VERSION_RELEASE = 8
...
const CPX_STAT_BENDERS_MASTER_UNBOUNDED = 40
...
const CPXMIP_BENDERS_MASTER_UNBOUNDED = 134
...
const CPXPARAM_MIP_Limits_SubMIPNodeLim = 2062
...
# Skipping Typedef: CXType_FunctionProto CPXNAMEFUNCTION

@cenum(CPXCALLBACKINFO,
...
@cenum(CPXCALLBACKSOLUTIONSTRATEGY,
