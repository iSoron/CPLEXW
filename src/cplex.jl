...
function CPXaddcols(env, lp, ccnt, nzcnt, obj, cmatbeg, cmatind, cmatval, lb, ub, colname)
    ccall((:CPXaddcols, libcplex), Cint, (CPXCENVptr, CPXLPptr, Cint, Cint, Ptr{Cdouble}, Ptr{Cint}, Ptr{Cint}, Ptr{Cdouble}, Ptr{Cdouble}, Ptr{Cdouble}, Ptr{Cstring}), env, lp, ccnt, nzcnt, obj, cmatbeg, cmatind, cmatval, lb, ub, colname)
end

function CPXaddfpdest(env, channel, fileptr)
    ccall((:CPXaddfpdest, libcplex), Cint, (CPXCENVptr, CPXCHANNELptr, CPXFILEptr), env, channel, fileptr)
end
...
function CPXaddpwl(env, lp, vary, varx, preslope, postslope, nbreaks, breakx, breaky, pwlname)
    ccall((:CPXaddpwl, libcplex), Cint, (CPXCENVptr, CPXLPptr, Cint, Cint, Cdouble, Cdouble, Cint, Ptr{Cdouble}, Ptr{Cdouble}, Cstring), env, lp, vary, varx, preslope, postslope, nbreaks, breakx, breaky, pwlname)
end

function CPXaddrows(env, lp, ccnt, rcnt, nzcnt, rhs, sense, rmatbeg, rmatind, rmatval, colname, rowname)
    ccall((:CPXaddrows, libcplex), Cint, (CPXCENVptr, CPXLPptr, Cint, Cint, Cint, Ptr{Cdouble}, Cstring, Ptr{Cint}, Ptr{Cint}, Ptr{Cdouble}, Ptr{Cstring}, Ptr{Cstring}), env, lp, ccnt, rcnt, nzcnt, rhs, sense, rmatbeg, rmatind, rmatval, colname, rowname)
end
...
function CPXcallbackaddusercuts(context, rcnt, nzcnt, rhs, sense, rmatbeg, rmatind, rmatval, purgeable, _local)
    ccall((:CPXcallbackaddusercuts, libcplex), Cint, (CPXCALLBACKCONTEXTptr, Cint, Cint, Ptr{Cdouble}, Cstring, Ptr{Cint}, Ptr{Cint}, Ptr{Cdouble}, Ptr{Cint}, Ptr{Cint}), context, rcnt, nzcnt, rhs, sense, rmatbeg, rmatind, rmatval, purgeable, _local)
end
...
function CPXcallbackrejectcandidate(context, rcnt, nzcnt, rhs, sense, rmatbeg, rmatind, rmatval)
    ccall((:CPXcallbackrejectcandidate, libcplex), Cint, (CPXCALLBACKCONTEXTptr, Cint, Cint, Ptr{Cdouble}, Cstring, Ptr{Cint}, Ptr{Cint}, Ptr{Cdouble}), context, rcnt, nzcnt, rhs, sense, rmatbeg, rmatind, rmatval)
end
...
function CPXchgbds(env, lp, cnt, indices, lu, bd)
    ccall((:CPXchgbds, libcplex), Cint, (CPXCENVptr, CPXLPptr, Cint, Ptr{Cint}, Cstring, Ptr{Cdouble}), env, lp, cnt, indices, lu, bd)
end
...
function CPXchgcolname(env, lp, cnt, indices, newname)
    ccall((:CPXchgcolname, libcplex), Cint, (CPXCENVptr, CPXLPptr, Cint, Ptr{Cint}, Ptr{Cstring}), env, lp, cnt, indices, newname)
end

function CPXchgname(env, lp, key, ij, newname_str)
    ccall((:CPXchgname, libcplex), Cint, (CPXCENVptr, CPXLPptr, Cint, Cint, Cstring), env, lp, key, ij, newname_str)
end
...
function CPXchgprobname(env, lp, probname)
    ccall((:CPXchgprobname, libcplex), Cint, (CPXCENVptr, CPXLPptr, Cstring), env, lp, probname)
end
...
function CPXchgrowname(env, lp, cnt, indices, newname)
    ccall((:CPXchgrowname, libcplex), Cint, (CPXCENVptr, CPXLPptr, Cint, Ptr{Cint}, Ptr{Cstring}), env, lp, cnt, indices, newname)
end

function CPXchgsense(env, lp, cnt, indices, sense)
    ccall((:CPXchgsense, libcplex), Cint, (CPXCENVptr, CPXLPptr, Cint, Ptr{Cint}, Cstring), env, lp, cnt, indices, sense)
end
...
function CPXcopylp(env, lp, numcols, numrows, objsense, objective, rhs, sense, matbeg, matcnt, matind, matval, lb, ub, rngval)
    ccall((:CPXcopylp, libcplex), Cint, (CPXCENVptr, CPXLPptr, Cint, Cint, Cint, Ptr{Cdouble}, Ptr{Cdouble}, Cstring, Ptr{Cint}, Ptr{Cint}, Ptr{Cint}, Ptr{Cdouble}, Ptr{Cdouble}, Ptr{Cdouble}, Ptr{Cdouble}), env, lp, numcols, numrows, objsense, objective, rhs, sense, matbeg, matcnt, matind, matval, lb, ub, rngval)
end
...
function CPXcopyobjname(env, lp, objname_str)
    ccall((:CPXcopyobjname, libcplex), Cint, (CPXCENVptr, CPXLPptr, Cstring), env, lp, objname_str)
end

function CPXcopypartialbase(env, lp, ccnt, cindices, cstat, rcnt, rindices, rstat)
    ccall((:CPXcopypartialbase, libcplex), Cint, (CPXCENVptr, CPXLPptr, Cint, Ptr{Cint}, Ptr{Cint}, Cint, Ptr{Cint}, Ptr{Cint}), env, lp, ccnt, cindices, cstat, rcnt, rindices, rstat)
end
...
function CPXcreateprob(env, status_p, probname_str)
    ccall((:CPXcreateprob, libcplex), CPXLPptr, (CPXCENVptr, Ptr{Cint}, Cstring), env, status_p, probname_str)
end
...
function CPXdelfpdest(env, channel, fileptr)
    ccall((:CPXdelfpdest, libcplex), Cint, (CPXCENVptr, CPXCHANNELptr, CPXFILEptr), env, channel, fileptr)
end
...
function CPXdperwrite(env, lp, filename_str, epsilon)
    ccall((:CPXdperwrite, libcplex), Cint, (CPXCENVptr, CPXLPptr, Cstring, Cdouble), env, lp, filename_str, epsilon)
end
...
function CPXdualwrite(env, lp, filename_str, objshift_p)
    ccall((:CPXdualwrite, libcplex), Cint, (CPXCENVptr, CPXCLPptr, Cstring, Ptr{Cdouble}), env, lp, filename_str, objshift_p)
end

function CPXembwrite(env, lp, filename_str)
    ccall((:CPXembwrite, libcplex), Cint, (CPXCENVptr, CPXLPptr, Cstring), env, lp, filename_str)
end

function CPXfclose(stream)
    ccall((:CPXfclose, libcplex), Cint, (CPXFILEptr,), stream)
end
...
function CPXfeasoptext(env, lp, grpcnt, concnt, grppref, grpbeg, grpind, grptype)
    ccall((:CPXfeasoptext, libcplex), Cint, (CPXCENVptr, CPXLPptr, Cint, Cint, Ptr{Cdouble}, Ptr{Cint}, Ptr{Cint}, Cstring), env, lp, grpcnt, concnt, grppref, grpbeg, grpind, grptype)
end
...
function CPXfopen(filename_str, type_str)
    ccall((:CPXfopen, libcplex), CPXFILEptr, (Cstring, Cstring), filename_str, type_str)
end

function CPXfputs(s_str, stream)
    ccall((:CPXfputs, libcplex), Cint, (Cstring, CPXFILEptr), s_str, stream)
end
...
function CPXgetcolindex(env, lp, lname_str, index_p)
    ccall((:CPXgetcolindex, libcplex), Cint, (CPXCENVptr, CPXCLPptr, Cstring, Ptr{Cint}), env, lp, lname_str, index_p)
end
...
function CPXgetcolname(env, lp, name, namestore, storespace, surplus_p, _begin, _end)
    ccall((:CPXgetcolname, libcplex), Cint, (CPXCENVptr, CPXCLPptr, Ptr{Cstring}, Cstring, Cint, Ptr{Cint}, Cint, Cint), env, lp, name, namestore, storespace, surplus_p, _begin, _end)
end
...
function CPXgetdblannotationindex(env, lp, annotationname_str, index_p)
    ccall((:CPXgetdblannotationindex, libcplex), Cint, (CPXCENVptr, CPXCLPptr, Cstring, Ptr{Cint}), env, lp, annotationname_str, index_p)
end

function CPXgetdblannotationname(env, lp, idx, buf_str, bufspace, surplus_p)
    ccall((:CPXgetdblannotationname, libcplex), Cint, (CPXCENVptr, CPXCLPptr, Cint, Cstring, Cint, Ptr{Cint}), env, lp, idx, buf_str, bufspace, surplus_p)
end
...
function CPXgeterrorstring(env, errcode, buffer_str)
    ccall((:CPXgeterrorstring, libcplex), CPXCCHARptr, (CPXCENVptr, Cint, Cstring), env, errcode, buffer_str)
end
...
function CPXgetlogfile(env, logfile_p)
    ccall((:CPXgetlogfile, libcplex), Cint, (CPXCENVptr, Ptr{CPXFILEptr}), env, logfile_p)
end

function CPXgetlogfilename(env, buf_str, bufspace, surplus_p)
    ccall((:CPXgetlogfilename, libcplex), Cint, (CPXCENVptr, Cstring, Cint, Ptr{Cint}), env, buf_str, bufspace, surplus_p)
end
...
function CPXgetlongannotationindex(env, lp, annotationname_str, index_p)
    ccall((:CPXgetlongannotationindex, libcplex), Cint, (CPXCENVptr, CPXCLPptr, Cstring, Ptr{Cint}), env, lp, annotationname_str, index_p)
end

function CPXgetlongannotationname(env, lp, idx, buf_str, bufspace, surplus_p)
    ccall((:CPXgetlongannotationname, libcplex), Cint, (CPXCENVptr, CPXCLPptr, Cint, Cstring, Cint, Ptr{Cint}), env, lp, idx, buf_str, bufspace, surplus_p)
end
...
function CPXgetobjname(env, lp, buf_str, bufspace, surplus_p)
    ccall((:CPXgetobjname, libcplex), Cint, (CPXCENVptr, CPXCLPptr, Cstring, Cint, Ptr{Cint}), env, lp, buf_str, bufspace, surplus_p)
end
...
function CPXgetparamname(env, whichparam, name_str)
    ccall((:CPXgetparamname, libcplex), Cint, (CPXCENVptr, Cint, Cstring), env, whichparam, name_str)
end

function CPXgetparamnum(env, name_str, whichparam_p)
    ccall((:CPXgetparamnum, libcplex), Cint, (CPXCENVptr, Cstring, Ptr{Cint}), env, name_str, whichparam_p)
end
...
function CPXgetprobname(env, lp, buf_str, bufspace, surplus_p)
    ccall((:CPXgetprobname, libcplex), Cint, (CPXCENVptr, CPXCLPptr, Cstring, Cint, Ptr{Cint}), env, lp, buf_str, bufspace, surplus_p)
end
...
function CPXgetpwlindex(env, lp, lname_str, index_p)
    ccall((:CPXgetpwlindex, libcplex), Cint, (CPXCENVptr, CPXCLPptr, Cstring, Ptr{Cint}), env, lp, lname_str, index_p)
end

function CPXgetpwlname(env, lp, buf_str, bufspace, surplus_p, which)
    ccall((:CPXgetpwlname, libcplex), Cint, (CPXCENVptr, CPXCLPptr, Cstring, Cint, Ptr{Cint}, Cint), env, lp, buf_str, bufspace, surplus_p, which)
end
...
function CPXgetrowindex(env, lp, lname_str, index_p)
    ccall((:CPXgetrowindex, libcplex), Cint, (CPXCENVptr, CPXCLPptr, Cstring, Ptr{Cint}), env, lp, lname_str, index_p)
end
...
function CPXgetrowname(env, lp, name, namestore, storespace, surplus_p, _begin, _end)
    ccall((:CPXgetrowname, libcplex), Cint, (CPXCENVptr, CPXCLPptr, Ptr{Cstring}, Cstring, Cint, Ptr{Cint}, Cint, Cint), env, lp, name, namestore, storespace, surplus_p, _begin, _end)
end
...
function CPXgetsense(env, lp, sense, _begin, _end)
    ccall((:CPXgetsense, libcplex), Cint, (CPXCENVptr, CPXCLPptr, Cstring, Cint, Cint), env, lp, sense, _begin, _end)
end
...
function CPXgetstatstring(env, statind, buffer_str)
    ccall((:CPXgetstatstring, libcplex), CPXCHARptr, (CPXCENVptr, Cint, Cstring), env, statind, buffer_str)
end

function CPXgetstrparam(env, whichparam, value_str)
    ccall((:CPXgetstrparam, libcplex), Cint, (CPXCENVptr, Cint, Cstring), env, whichparam, value_str)
end
...
function CPXinfostrparam(env, whichparam, defvalue_str)
    ccall((:CPXinfostrparam, libcplex), Cint, (CPXCENVptr, Cint, Cstring), env, whichparam, defvalue_str)
end
...
function CPXmbasewrite(env, lp, filename_str)
    ccall((:CPXmbasewrite, libcplex), Cint, (CPXCENVptr, CPXCLPptr, Cstring), env, lp, filename_str)
end
...
function CPXnewcols(env, lp, ccnt, obj, lb, ub, xctype, colname)
    ccall((:CPXnewcols, libcplex), Cint, (CPXCENVptr, CPXLPptr, Cint, Ptr{Cdouble}, Ptr{Cdouble}, Ptr{Cdouble}, Cstring, Ptr{Cstring}), env, lp, ccnt, obj, lb, ub, xctype, colname)
end

function CPXnewdblannotation(env, lp, annotationname_str, defval)
    ccall((:CPXnewdblannotation, libcplex), Cint, (CPXCENVptr, CPXLPptr, Cstring, Cdouble), env, lp, annotationname_str, defval)
end

function CPXnewlongannotation(env, lp, annotationname_str, defval)
    ccall((:CPXnewlongannotation, libcplex), Cint, (CPXCENVptr, CPXLPptr, Cstring, CPXLONG), env, lp, annotationname_str, defval)
end

function CPXnewrows(env, lp, rcnt, rhs, sense, rngval, rowname)
    ccall((:CPXnewrows, libcplex), Cint, (CPXCENVptr, CPXLPptr, Cint, Ptr{Cdouble}, Cstring, Ptr{Cdouble}, Ptr{Cstring}), env, lp, rcnt, rhs, sense, rngval, rowname)
end
...
function CPXopenCPLEXruntime(status_p, serialnum, licenvstring_str)
    ccall((:CPXopenCPLEXruntime, libcplex), CPXENVptr, (Ptr{Cint}, Cint, Cstring), status_p, serialnum, licenvstring_str)
end
...
function CPXpperwrite(env, lp, filename_str, epsilon)
    ccall((:CPXpperwrite, libcplex), Cint, (CPXCENVptr, CPXLPptr, Cstring, Cdouble), env, lp, filename_str, epsilon)
end
...
function CPXpreaddrows(env, lp, rcnt, nzcnt, rhs, sense, rmatbeg, rmatind, rmatval, rowname)
    ccall((:CPXpreaddrows, libcplex), Cint, (CPXCENVptr, CPXLPptr, Cint, Cint, Ptr{Cdouble}, Cstring, Ptr{Cint}, Ptr{Cint}, Ptr{Cdouble}, Ptr{Cstring}), env, lp, rcnt, nzcnt, rhs, sense, rmatbeg, rmatind, rmatval, rowname)
end
...
function CPXpreslvwrite(env, lp, filename_str, objoff_p)
    ccall((:CPXpreslvwrite, libcplex), Cint, (CPXCENVptr, CPXLPptr, Cstring, Ptr{Cdouble}), env, lp, filename_str, objoff_p)
end
...
function CPXreadcopyannotations(env, lp, filename)
    ccall((:CPXreadcopyannotations, libcplex), Cint, (CPXCENVptr, CPXLPptr, Cstring), env, lp, filename)
end
...
function CPXreadcopyparam(env, filename_str)
    ccall((:CPXreadcopyparam, libcplex), Cint, (CPXENVptr, Cstring), env, filename_str)
end

function CPXreadcopyprob(env, lp, filename_str, filetype)
    ccall((:CPXreadcopyprob, libcplex), Cint, (CPXCENVptr, CPXLPptr, Cstring, Cstring), env, lp, filename_str, filetype)
end
...
function CPXrefineconflictext(env, lp, grpcnt, concnt, grppref, grpbeg, grpind, grptype)
    ccall((:CPXrefineconflictext, libcplex), Cint, (CPXCENVptr, CPXLPptr, Cint, Cint, Ptr{Cdouble}, Ptr{Cint}, Ptr{Cint}, Cstring), env, lp, grpcnt, concnt, grppref, grpbeg, grpind, grptype)
end
...
function CPXsavwrite(env, lp, filename_str)
    ccall((:CPXsavwrite, libcplex), Cint, (CPXCENVptr, CPXCLPptr, Cstring), env, lp, filename_str)
end
...
function CPXsetlogfile(env, lfile)
    ccall((:CPXsetlogfile, libcplex), Cint, (CPXENVptr, CPXFILEptr), env, lfile)
end

function CPXsetlogfilename(env, filename, mode)
    ccall((:CPXsetlogfilename, libcplex), Cint, (CPXCENVptr, Cstring, Cstring), env, filename, mode)
end
...
function CPXsetstrparam(env, whichparam, newvalue_str)
    ccall((:CPXsetstrparam, libcplex), Cint, (CPXENVptr, Cint, Cstring), env, whichparam, newvalue_str)
end
...
function CPXsolwrite(env, lp, filename_str)
    ccall((:CPXsolwrite, libcplex), Cint, (CPXCENVptr, CPXCLPptr, Cstring), env, lp, filename_str)
end

function CPXsolwritesolnpool(env, lp, soln, filename_str)
    ccall((:CPXsolwritesolnpool, libcplex), Cint, (CPXCENVptr, CPXCLPptr, Cint, Cstring), env, lp, soln, filename_str)
end
...
function CPXtightenbds(env, lp, cnt, indices, lu, bd)
    ccall((:CPXtightenbds, libcplex), Cint, (CPXCENVptr, CPXLPptr, Cint, Ptr{Cint}, Cstring, Ptr{Cdouble}), env, lp, cnt, indices, lu, bd)
end

function CPXtuneparam(env, lp, intcnt, intnum, intval, dblcnt, dblnum, dblval, strcnt, strnum, strval, tunestat_p)
    ccall((:CPXtuneparam, libcplex), Cint, (CPXENVptr, CPXLPptr, Cint, Ptr{Cint}, Ptr{Cint}, Cint, Ptr{Cint}, Ptr{Cdouble}, Cint, Ptr{Cint}, Ptr{Cstring}, Ptr{Cint}), env, lp, intcnt, intnum, intval, dblcnt, dblnum, dblval, strcnt, strnum, strval, tunestat_p)
end
...
function CPXtuneparamprobset(env, filecnt, filename, filetype, intcnt, intnum, intval, dblcnt, dblnum, dblval, strcnt, strnum, strval, tunestat_p)
    ccall((:CPXtuneparamprobset, libcplex), Cint, (CPXENVptr, Cint, Ptr{Cstring}, Ptr{Cstring}, Cint, Ptr{Cint}, Ptr{Cint}, Cint, Ptr{Cint}, Ptr{Cdouble}, Cint, Ptr{Cint}, Ptr{Cstring}, Ptr{Cint}), env, filecnt, filename, filetype, intcnt, intnum, intval, dblcnt, dblnum, dblval, strcnt, strnum, strval, tunestat_p)
end
...
function CPXwriteannotations(env, lp, filename)
    ccall((:CPXwriteannotations, libcplex), Cint, (CPXCENVptr, CPXCLPptr, Cstring), env, lp, filename)
end

function CPXwritebendersannotation(env, lp, filename)
    ccall((:CPXwritebendersannotation, libcplex), Cint, (CPXCENVptr, CPXCLPptr, Cstring), env, lp, filename)
end

function CPXwriteparam(env, filename_str)
    ccall((:CPXwriteparam, libcplex), Cint, (CPXCENVptr, Cstring), env, filename_str)
end

function CPXwriteprob(env, lp, filename_str, filetype)
    ccall((:CPXwriteprob, libcplex), Cint, (CPXCENVptr, CPXCLPptr, Cstring, Cstring), env, lp, filename_str, filetype)
end
...
function CPXaddindconstraints(env, lp, indcnt, type, indvar, complemented, nzcnt, rhs, sense, linbeg, linind, linval, indname)
    ccall((:CPXaddindconstraints, libcplex), Cint, (CPXCENVptr, CPXLPptr, Cint, Ptr{Cint}, Ptr{Cint}, Ptr{Cint}, Cint, Ptr{Cdouble}, Cstring, Ptr{Cint}, Ptr{Cint}, Ptr{Cdouble}, Ptr{Cstring}), env, lp, indcnt, type, indvar, complemented, nzcnt, rhs, sense, linbeg, linind, linval, indname)
end

function CPXaddlazyconstraints(env, lp, rcnt, nzcnt, rhs, sense, rmatbeg, rmatind, rmatval, rowname)
    ccall((:CPXaddlazyconstraints, libcplex), Cint, (CPXCENVptr, CPXLPptr, Cint, Cint, Ptr{Cdouble}, Cstring, Ptr{Cint}, Ptr{Cint}, Ptr{Cdouble}, Ptr{Cstring}), env, lp, rcnt, nzcnt, rhs, sense, rmatbeg, rmatind, rmatval, rowname)
end

function CPXaddmipstarts(env, lp, mcnt, nzcnt, beg, varindices, values, effortlevel, mipstartname)
    ccall((:CPXaddmipstarts, libcplex), Cint, (CPXCENVptr, CPXLPptr, Cint, Cint, Ptr{Cint}, Ptr{Cint}, Ptr{Cdouble}, Ptr{Cint}, Ptr{Cstring}), env, lp, mcnt, nzcnt, beg, varindices, values, effortlevel, mipstartname)
end

function CPXaddsolnpooldivfilter(env, lp, lower_bound, upper_bound, nzcnt, ind, weight, refval, lname_str)
    ccall((:CPXaddsolnpooldivfilter, libcplex), Cint, (CPXCENVptr, CPXLPptr, Cdouble, Cdouble, Cint, Ptr{Cint}, Ptr{Cdouble}, Ptr{Cdouble}, Cstring), env, lp, lower_bound, upper_bound, nzcnt, ind, weight, refval, lname_str)
end

function CPXaddsolnpoolrngfilter(env, lp, lb, ub, nzcnt, ind, val, lname_str)
    ccall((:CPXaddsolnpoolrngfilter, libcplex), Cint, (CPXCENVptr, CPXLPptr, Cdouble, Cdouble, Cint, Ptr{Cint}, Ptr{Cdouble}, Cstring), env, lp, lb, ub, nzcnt, ind, val, lname_str)
end

function CPXaddsos(env, lp, numsos, numsosnz, sostype, sosbeg, sosind, soswt, sosname)
    ccall((:CPXaddsos, libcplex), Cint, (CPXCENVptr, CPXLPptr, Cint, Cint, Cstring, Ptr{Cint}, Ptr{Cint}, Ptr{Cdouble}, Ptr{Cstring}), env, lp, numsos, numsosnz, sostype, sosbeg, sosind, soswt, sosname)
end

function CPXaddusercuts(env, lp, rcnt, nzcnt, rhs, sense, rmatbeg, rmatind, rmatval, rowname)
    ccall((:CPXaddusercuts, libcplex), Cint, (CPXCENVptr, CPXLPptr, Cint, Cint, Ptr{Cdouble}, Cstring, Ptr{Cint}, Ptr{Cint}, Ptr{Cdouble}, Ptr{Cstring}), env, lp, rcnt, nzcnt, rhs, sense, rmatbeg, rmatind, rmatval, rowname)
end
...
function CPXbranchcallbackbranchbds(env, cbdata, wherefrom, cnt, indices, lu, bd, nodeest, userhandle, seqnum_p)
    ccall((:CPXbranchcallbackbranchbds, libcplex), Cint, (CPXCENVptr, Ptr{Cvoid}, Cint, Cint, Ptr{Cint}, Cstring, Ptr{Cdouble}, Cdouble, Ptr{Cvoid}, Ptr{Cint}), env, cbdata, wherefrom, cnt, indices, lu, bd, nodeest, userhandle, seqnum_p)
end
...
function CPXbranchcallbackbranchconstraints(env, cbdata, wherefrom, rcnt, nzcnt, rhs, sense, rmatbeg, rmatind, rmatval, nodeest, userhandle, seqnum_p)
    ccall((:CPXbranchcallbackbranchconstraints, libcplex), Cint, (CPXCENVptr, Ptr{Cvoid}, Cint, Cint, Cint, Ptr{Cdouble}, Cstring, Ptr{Cint}, Ptr{Cint}, Ptr{Cdouble}, Cdouble, Ptr{Cvoid}, Ptr{Cint}), env, cbdata, wherefrom, rcnt, nzcnt, rhs, sense, rmatbeg, rmatind, rmatval, nodeest, userhandle, seqnum_p)
end
...
function CPXchgctype(env, lp, cnt, indices, xctype)
    ccall((:CPXchgctype, libcplex), Cint, (CPXCENVptr, CPXLPptr, Cint, Ptr{Cint}, Cstring), env, lp, cnt, indices, xctype)
end
...
function CPXcopyctype(env, lp, xctype)
    ccall((:CPXcopyctype, libcplex), Cint, (CPXCENVptr, CPXLPptr, Cstring), env, lp, xctype)
end
...
function CPXcopysos(env, lp, numsos, numsosnz, sostype, sosbeg, sosind, soswt, sosname)
    ccall((:CPXcopysos, libcplex), Cint, (CPXCENVptr, CPXLPptr, Cint, Cint, Cstring, Ptr{Cint}, Ptr{Cint}, Ptr{Cdouble}, Ptr{Cstring}), env, lp, numsos, numsosnz, sostype, sosbeg, sosind, soswt, sosname)
end
...
function CPXgetcallbackbranchconstraints(env, cbdata, wherefrom, which, cuts_p, nzcnt_p, rhs, sense, rmatbeg, rmatind, rmatval, rmatsz, surplus_p)
    ccall((:CPXgetcallbackbranchconstraints, libcplex), Cint, (CPXCENVptr, Ptr{Cvoid}, Cint, Cint, Ptr{Cint}, Ptr{Cint}, Ptr{Cdouble}, Cstring, Ptr{Cint}, Ptr{Cint}, Ptr{Cdouble}, Cint, Ptr{Cint}), env, cbdata, wherefrom, which, cuts_p, nzcnt_p, rhs, sense, rmatbeg, rmatind, rmatval, rmatsz, surplus_p)
end

function CPXgetcallbackctype(env, cbdata, wherefrom, xctype, _begin, _end)
    ccall((:CPXgetcallbackctype, libcplex), Cint, (CPXCENVptr, Ptr{Cvoid}, Cint, Cstring, Cint, Cint), env, cbdata, wherefrom, xctype, _begin, _end)
end
...
function CPXgetctype(env, lp, xctype, _begin, _end)
    ccall((:CPXgetctype, libcplex), Cint, (CPXCENVptr, CPXCLPptr, Cstring, Cint, Cint), env, lp, xctype, _begin, _end)
end
...
function CPXgetindconstr(env, lp, indvar_p, complemented_p, nzcnt_p, rhs_p, sense_p, linind, linval, space, surplus_p, which)
    ccall((:CPXgetindconstr, libcplex), Cint, (CPXCENVptr, CPXCLPptr, Ptr{Cint}, Ptr{Cint}, Ptr{Cint}, Ptr{Cdouble}, Cstring, Ptr{Cint}, Ptr{Cdouble}, Cint, Ptr{Cint}, Cint), env, lp, indvar_p, complemented_p, nzcnt_p, rhs_p, sense_p, linind, linval, space, surplus_p, which)
end
...
function CPXgetindconstraints(env, lp, type, indvar, complemented, nzcnt_p, rhs, sense, linbeg, linind, linval, linspace, surplus_p, _begin, _end)
    ccall((:CPXgetindconstraints, libcplex), Cint, (CPXCENVptr, CPXCLPptr, Ptr{Cint}, Ptr{Cint}, Ptr{Cint}, Ptr{Cint}, Ptr{Cdouble}, Cstring, Ptr{Cint}, Ptr{Cint}, Ptr{Cdouble}, Cint, Ptr{Cint}, Cint, Cint), env, lp, type, indvar, complemented, nzcnt_p, rhs, sense, linbeg, linind, linval, linspace, surplus_p, _begin, _end)
end

function CPXgetindconstrindex(env, lp, lname_str, index_p)
    ccall((:CPXgetindconstrindex, libcplex), Cint, (CPXCENVptr, CPXCLPptr, Cstring, Ptr{Cint}), env, lp, lname_str, index_p)
end
...
function CPXgetindconstrname(env, lp, buf_str, bufspace, surplus_p, which)
    ccall((:CPXgetindconstrname, libcplex), Cint, (CPXCENVptr, CPXCLPptr, Cstring, Cint, Ptr{Cint}, Cint), env, lp, buf_str, bufspace, surplus_p, which)
end
...
function CPXgetmipstartindex(env, lp, lname_str, index_p)
    ccall((:CPXgetmipstartindex, libcplex), Cint, (CPXCENVptr, CPXCLPptr, Cstring, Ptr{Cint}), env, lp, lname_str, index_p)
end

function CPXgetmipstartname(env, lp, name, store, storesz, surplus_p, _begin, _end)
    ccall((:CPXgetmipstartname, libcplex), Cint, (CPXCENVptr, CPXCLPptr, Ptr{Cstring}, Cstring, Cint, Ptr{Cint}, Cint, Cint), env, lp, name, store, storesz, surplus_p, _begin, _end)
end
...
function CPXgetsolnpoolfilterindex(env, lp, lname_str, index_p)
    ccall((:CPXgetsolnpoolfilterindex, libcplex), Cint, (CPXCENVptr, CPXCLPptr, Cstring, Ptr{Cint}), env, lp, lname_str, index_p)
end

function CPXgetsolnpoolfiltername(env, lp, buf_str, bufspace, surplus_p, which)
    ccall((:CPXgetsolnpoolfiltername, libcplex), Cint, (CPXCENVptr, CPXCLPptr, Cstring, Cint, Ptr{Cint}, Cint), env, lp, buf_str, bufspace, surplus_p, which)
end
...
function CPXgetsolnpoolsolnindex(env, lp, lname_str, index_p)
    ccall((:CPXgetsolnpoolsolnindex, libcplex), Cint, (CPXCENVptr, CPXCLPptr, Cstring, Ptr{Cint}), env, lp, lname_str, index_p)
end

function CPXgetsolnpoolsolnname(env, lp, store, storesz, surplus_p, which)
    ccall((:CPXgetsolnpoolsolnname, libcplex), Cint, (CPXCENVptr, CPXCLPptr, Cstring, Cint, Ptr{Cint}, Cint), env, lp, store, storesz, surplus_p, which)
end
...
function CPXgetsos(env, lp, numsosnz_p, sostype, sosbeg, sosind, soswt, sosspace, surplus_p, _begin, _end)
    ccall((:CPXgetsos, libcplex), Cint, (CPXCENVptr, CPXCLPptr, Ptr{Cint}, Cstring, Ptr{Cint}, Ptr{Cint}, Ptr{Cdouble}, Cint, Ptr{Cint}, Cint, Cint), env, lp, numsosnz_p, sostype, sosbeg, sosind, soswt, sosspace, surplus_p, _begin, _end)
end

function CPXgetsosindex(env, lp, lname_str, index_p)
    ccall((:CPXgetsosindex, libcplex), Cint, (CPXCENVptr, CPXCLPptr, Cstring, Ptr{Cint}), env, lp, lname_str, index_p)
end
...
function CPXgetsosname(env, lp, name, namestore, storespace, surplus_p, _begin, _end)
    ccall((:CPXgetsosname, libcplex), Cint, (CPXCENVptr, CPXCLPptr, Ptr{Cstring}, Cstring, Cint, Ptr{Cint}, Cint, Cint), env, lp, name, namestore, storespace, surplus_p, _begin, _end)
end
...
function CPXordread(env, filename_str, numcols, colname, cnt_p, indices, priority, direction)
    ccall((:CPXordread, libcplex), Cint, (CPXCENVptr, Cstring, Cint, Ptr{Cstring}, Ptr{Cint}, Ptr{Cint}, Ptr{Cint}, Ptr{Cint}), env, filename_str, numcols, colname, cnt_p, indices, priority, direction)
end
...
function CPXrefinemipstartconflictext(env, lp, mipstartindex, grpcnt, concnt, grppref, grpbeg, grpind, grptype)
    ccall((:CPXrefinemipstartconflictext, libcplex), Cint, (CPXCENVptr, CPXLPptr, Cint, Cint, Cint, Ptr{Cdouble}, Ptr{Cint}, Ptr{Cint}, Cstring), env, lp, mipstartindex, grpcnt, concnt, grppref, grpbeg, grpind, grptype)
end
...
function CPXwritemipstarts(env, lp, filename_str, _begin, _end)
    ccall((:CPXwritemipstarts, libcplex), Cint, (CPXCENVptr, CPXCLPptr, Cstring, Cint, Cint), env, lp, filename_str, _begin, _end)
end

function CPXaddindconstr(env, lp, indvar, complemented, nzcnt, rhs, sense, linind, linval, indname_str)
    ccall((:CPXaddindconstr, libcplex), Cint, (CPXCENVptr, CPXLPptr, Cint, Cint, Cint, Cdouble, Cint, Ptr{Cint}, Ptr{Cdouble}, Cstring), env, lp, indvar, complemented, nzcnt, rhs, sense, linind, linval, indname_str)
end

function CPXNETaddarcs(env, net, narcs, fromnode, tonode, low, up, obj, anames)
    ccall((:CPXNETaddarcs, libcplex), Cint, (CPXCENVptr, CPXNETptr, Cint, Ptr{Cint}, Ptr{Cint}, Ptr{Cdouble}, Ptr{Cdouble}, Ptr{Cdouble}, Ptr{Cstring}), env, net, narcs, fromnode, tonode, low, up, obj, anames)
end

function CPXNETaddnodes(env, net, nnodes, supply, name)
    ccall((:CPXNETaddnodes, libcplex), Cint, (CPXCENVptr, CPXNETptr, Cint, Ptr{Cdouble}, Ptr{Cstring}), env, net, nnodes, supply, name)
end

function CPXNETbasewrite(env, net, filename_str)
    ccall((:CPXNETbasewrite, libcplex), Cint, (CPXCENVptr, CPXCNETptr, Cstring), env, net, filename_str)
end

function CPXNETchgarcname(env, net, cnt, indices, newname)
    ccall((:CPXNETchgarcname, libcplex), Cint, (CPXCENVptr, CPXNETptr, Cint, Ptr{Cint}, Ptr{Cstring}), env, net, cnt, indices, newname)
end
...
function CPXNETchgbds(env, net, cnt, indices, lu, bd)
    ccall((:CPXNETchgbds, libcplex), Cint, (CPXCENVptr, CPXNETptr, Cint, Ptr{Cint}, Cstring, Ptr{Cdouble}), env, net, cnt, indices, lu, bd)
end

function CPXNETchgname(env, net, key, vindex, name_str)
    ccall((:CPXNETchgname, libcplex), Cint, (CPXCENVptr, CPXNETptr, Cint, Cint, Cstring), env, net, key, vindex, name_str)
end

function CPXNETchgnodename(env, net, cnt, indices, newname)
    ccall((:CPXNETchgnodename, libcplex), Cint, (CPXCENVptr, CPXNETptr, Cint, Ptr{Cint}, Ptr{Cstring}), env, net, cnt, indices, newname)
end
...
function CPXNETcopynet(env, net, objsen, nnodes, supply, nnames, narcs, fromnode, tonode, low, up, obj, anames)
    ccall((:CPXNETcopynet, libcplex), Cint, (CPXCENVptr, CPXNETptr, Cint, Cint, Ptr{Cdouble}, Ptr{Cstring}, Cint, Ptr{Cint}, Ptr{Cint}, Ptr{Cdouble}, Ptr{Cdouble}, Ptr{Cdouble}, Ptr{Cstring}), env, net, objsen, nnodes, supply, nnames, narcs, fromnode, tonode, low, up, obj, anames)
end
...
function CPXNETgetarcindex(env, net, lname_str, index_p)
    ccall((:CPXNETgetarcindex, libcplex), Cint, (CPXCENVptr, CPXCNETptr, Cstring, Ptr{Cint}), env, net, lname_str, index_p)
end

function CPXNETgetarcname(env, net, nnames, namestore, namespc, surplus_p, _begin, _end)
    ccall((:CPXNETgetarcname, libcplex), Cint, (CPXCENVptr, CPXCNETptr, Ptr{Cstring}, Cstring, Cint, Ptr{Cint}, Cint, Cint), env, net, nnames, namestore, namespc, surplus_p, _begin, _end)
end
...
function CPXNETgetnodeindex(env, net, lname_str, index_p)
    ccall((:CPXNETgetnodeindex, libcplex), Cint, (CPXCENVptr, CPXCNETptr, Cstring, Ptr{Cint}), env, net, lname_str, index_p)
end

function CPXNETgetnodename(env, net, nnames, namestore, namespc, surplus_p, _begin, _end)
    ccall((:CPXNETgetnodename, libcplex), Cint, (CPXCENVptr, CPXCNETptr, Ptr{Cstring}, Cstring, Cint, Ptr{Cint}, Cint, Cint), env, net, nnames, namestore, namespc, surplus_p, _begin, _end)
end
...
function CPXNETgetprobname(env, net, buf_str, bufspace, surplus_p)
    ccall((:CPXNETgetprobname, libcplex), Cint, (CPXCENVptr, CPXCNETptr, Cstring, Cint, Ptr{Cint}), env, net, buf_str, bufspace, surplus_p)
end
...
function CPXNETreadcopybase(env, net, filename_str)
    ccall((:CPXNETreadcopybase, libcplex), Cint, (CPXCENVptr, CPXNETptr, Cstring), env, net, filename_str)
end

function CPXNETreadcopyprob(env, net, filename_str)
    ccall((:CPXNETreadcopyprob, libcplex), Cint, (CPXCENVptr, CPXNETptr, Cstring), env, net, filename_str)
end
...
function CPXNETwriteprob(env, net, filename_str, format_str)
    ccall((:CPXNETwriteprob, libcplex), Cint, (CPXCENVptr, CPXCNETptr, Cstring, Cstring), env, net, filename_str, format_str)
end
...
function CPXaddqconstr(env, lp, linnzcnt, quadnzcnt, rhs, sense, linind, linval, quadrow, quadcol, quadval, lname_str)
    ccall((:CPXaddqconstr, libcplex), Cint, (CPXCENVptr, CPXLPptr, Cint, Cint, Cdouble, Cint, Ptr{Cint}, Ptr{Cdouble}, Ptr{Cint}, Ptr{Cint}, Ptr{Cdouble}, Cstring), env, lp, linnzcnt, quadnzcnt, rhs, sense, linind, linval, quadrow, quadcol, quadval, lname_str)
end
...
function CPXgetqconstr(env, lp, linnzcnt_p, quadnzcnt_p, rhs_p, sense_p, linind, linval, linspace, linsurplus_p, quadrow, quadcol, quadval, quadspace, quadsurplus_p, which)
    ccall((:CPXgetqconstr, libcplex), Cint, (CPXCENVptr, CPXCLPptr, Ptr{Cint}, Ptr{Cint}, Ptr{Cdouble}, Cstring, Ptr{Cint}, Ptr{Cdouble}, Cint, Ptr{Cint}, Ptr{Cint}, Ptr{Cint}, Ptr{Cdouble}, Cint, Ptr{Cint}, Cint), env, lp, linnzcnt_p, quadnzcnt_p, rhs_p, sense_p, linind, linval, linspace, linsurplus_p, quadrow, quadcol, quadval, quadspace, quadsurplus_p, which)
end
...
function CPXgetqconstrindex(env, lp, lname_str, index_p)
    ccall((:CPXgetqconstrindex, libcplex), Cint, (CPXCENVptr, CPXCLPptr, Cstring, Ptr{Cint}), env, lp, lname_str, index_p)
end
...
function CPXgetqconstrname(env, lp, buf_str, bufspace, surplus_p, which)
    ccall((:CPXgetqconstrname, libcplex), Cint, (CPXCENVptr, CPXCLPptr, Cstring, Cint, Ptr{Cint}, Cint), env, lp, buf_str, bufspace, surplus_p, which)
end
